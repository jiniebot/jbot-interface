...
class IzurviveMap {
  ...
  static chernarusPlus() {
    return new IzurviveMap(new Size(15360, 15360), 0.9644165039); // Corrected from official repo
  }

  static livonia() {
    return new IzurviveMap(new Size(12800, 12800), 1.0);
  }
}
...
class IzurviveTransformation {
  ...
  dayzPointToIzurviveCoordinate(point) {
    return SphericalMercator.unproject(this.linearTransform.reverse(point));
  }
